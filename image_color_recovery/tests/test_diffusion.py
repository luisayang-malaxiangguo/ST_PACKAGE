"""
Unit tests for Gaussian Diffusion-Propagation colorization subpackage.
"""
...
class TestDiffusion(unittest.TestCase):
    def test_builder(self):
        """
        Check builder returns correct image dimensions.
        """
    ...
    def test_solver(self):
        """
        Check solver returns outputs of the expected shape and error history length.
        """
        ...
        recovered_gpu, errors = solver.diffusion_colorize_3ch_with_error(
            gray_gpu,
            known_mask_gpu,
            known_vals_gpu,
            original_3ch_gpu,
